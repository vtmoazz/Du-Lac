...
export const timelineItems = [
  { label: 'Thanh xuân', text: 'Hai người cùng nuôi giấc mơ khám phá văn hóa Việt.' },
  { label: 'Tuổi trẻ', text: 'Họ đi qua phố cổ, sông nước, lễ hội và làng nghề.' },
  { label: 'Tuổi 30', text: 'Cả hai quyết định xây dựng mái ấm và nhận con nuôi.' },
  { label: 'Biến cố', text: 'Tai nạn kép làm cuộc đời họ đứt gãy.' },
  { label: 'Ba năm', text: 'Lan Anh chăm sóc Tính trong im lặng.' },
  { label: 'Thức tỉnh', text: 'Tiếng trống rối nước đánh thức phản xạ của Tính.' },
  { label: 'Hành trình mới', text: 'Lan Anh đưa Tính trở về làng cổ đầu tiên.' },
]
