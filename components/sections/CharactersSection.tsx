  ...
  return (
    <Section id="characters" variant="paper">
      <div className="mx-auto max-w-2xl text-center">
        <p className="section-divider text-sm font-bold uppercase tracking-[0.22em] text-dulac-red">Nhân vật</p>
        ...
        <p className="mt-4 text-base leading-8 text-dulac-ink/62">
